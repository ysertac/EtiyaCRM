...
public class AWHKPSPublicSoap12
{
    ...
    public AWHKPSPublicSoap12(){}

    public AWHKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public AWHKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AWHExtendedSoapSerializationEnvelope envelope= new AWHExtendedSoapSerializationEnvelope(AWHExtendedSoapSerializationEnvelope.VER12);
